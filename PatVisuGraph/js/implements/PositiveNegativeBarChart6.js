...
var PositiveNegativeBar_Sheet6 = function(divName, svgName, jsonName){
	var classification = new Array(), nationCode = new Array();
	var classDataSet = [], nationDataSet = [], companyDataSet = new Array();
	...
	$.getJSON(".//"+jsonName+".json", function(json, error){
		...
		var halfWidth = (parseInt(svg.style("width")) - 100) / 2;
		var height, width;
