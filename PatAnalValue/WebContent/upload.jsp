	  ...
	  <div class="outer">
	    <div class="inner">
	      <div class="centered">
			...
			<form action = "/PatVisu/upload_excel.jsp" method = "post" enctype = "multipart/form-data">
				업로드 할 파일을 선택하세요(*.xls, *.xlsx)
				<!-- //엑셀 파일만 입력 -->
				<br><br>
			...
			<form action = "/PatVisu/upload_code.jsp" method = "post" enctype = "multipart/form-data">
				기본 설정 값 파일을 선택하세요.(*.xls, *.xlsx)
				<br><br>
				<input type="hidden" name="cmd" value="parsingExcel2" />
				<input type="file" name="upExcelFile" id="upExcelFile" accept="application/vnd.ms-excel, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet">
				<input type="submit" value = "확인">
				<br><br>
