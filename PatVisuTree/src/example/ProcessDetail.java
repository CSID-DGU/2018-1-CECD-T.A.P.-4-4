...
/**
 * Servlet implementation class ProcessDetail
 */
@WebServlet("/ProcessDetail")
public class ProcessDetail extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (cmd == null || cmd.equals("viewDetail")) {
			try {
	...
	public void viewDetail(HttpServletRequest request, HttpServletResponse response) throws SQLException, ClassNotFoundException, ServletException, IOException {
		...
		String pSorted_index = request.getParameter("pSorted_index");
		String pADS =request.getParameter("pADS");
		...
		request.setAttribute("pa", "ProcessList");;
